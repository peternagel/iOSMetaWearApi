...
/// Class for BLEDevice MetaWear
@interface BLEDevice : NSObject

@property (strong,nonatomic) CBPeripheral *p; /**< Pointer to CoreBluetooth peripheral */
@property (strong,nonatomic) CBCentralManager *manager; /**< Pointer to CoreBluetooth manager that found this peripheral */
@property NSMutableDictionary *setupData; /**< Pointer to dictionary with device setup data */
